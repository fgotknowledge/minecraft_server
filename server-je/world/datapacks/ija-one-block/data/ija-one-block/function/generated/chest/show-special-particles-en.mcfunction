...
execute if block ~ ~ ~ chest{"CustomName":"{\"text\":\"Odd Chest\",\"color\":\"black\"}"} run particle minecraft:squid_ink ~ ~ ~ 0.4 0.4 0.4 0.001 1 force
...
execute if block ~ ~ ~ chest{"CustomName":"{\"text\":\"Variety Chest\",\"color\":\"blue\"}"} run particle minecraft:sneeze ~ ~ ~ 0.4 0.4 0.4 0.001 2 force